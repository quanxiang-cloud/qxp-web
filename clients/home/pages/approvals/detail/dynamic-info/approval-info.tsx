...
const statusDescribe: StatusDescribe = {
  OR_APPROVAL: { text: '或签', describe: '任意一位负责人通过即可' },
  AND_APPROVAL: { text: '会签', describe: '需全部负责人通过方可通过' },
};
...
export default function ApprovalInfo({ workData, returnFlowPage }: Props): JSX.Element {
  ...
  return (
    <div>
      ...
      <div className="py-16">
        ...
        {
          (noHandleData.length > 0 && isNoFinish) && (
