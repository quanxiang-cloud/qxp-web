import React, {
  CSSProperties, forwardRef, ReactNode, useEffect, useImperativeHandle, ForwardedRef,
} from 'react';
...
const DropdownMenu = (props: DropdownMenuProps, ref: ForwardedRef<DropdownMenuInstance>): JSX.Element => {
  const {
    direction = 'down',
    overlay = true,
    duration = 200,
...
export default forwardRef<DropdownMenuInstance, DropdownMenuProps>(DropdownMenu);
