...
import { Menu } from '@m/pages/apps/types';
import { MenuType } from '@portal/modules/apps-management/pages/app-details/type';
import detailStore from '@m/pages/apps/page-detail/store';
...
import { mapColor } from '@m/pages/apps/utils';
...
function AppDetail(): JSX.Element {
  ...
  return (
    <NavPage title={store.app?.name ?? appID} style={{ padding: '.12rem .16rem' }}>
      {store.state.loading && <Loading>加载中...</Loading>}
