...
import CircleButton from '../ArrayTable/CircleButton';
import TextButton from '../ArrayTable/TextButton';
...
const styledArrayCards = styled(ArrayCards)`
  width: 100%;
  .ant-card {
    .ant-card {
      box-shadow: none;
...
styledArrayCards.isFieldComponent = true;

export default styledArrayCards;
