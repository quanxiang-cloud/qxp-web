...
function Uploader(props: ISchemaFieldComponentProps): JSX.Element {
  ...
  return (
    <div className="file-upload">
      ...
      >
        <div className="uploader flex items-center justify-center">
          <p className="text-black-100 hover:text-black-200 text-center">点击或拖动文件上传，最大5M</p>
        </div>
      </Upload>
