...
import { AssociatedTableConfig } from './convertor';
import LinkedTableField from './linked-table-field';

interface Props {
  initialValue: AssociatedTableConfig;
  onChange: (params: AssociatedTableConfig) => void;
}
...
function AssociatedTableConfig(props: Props): JSX.Element {
...
export default AssociatedTableConfig;
