...
import FieldSwitch from '@portal/modules/app-management/components/field-switch';
import Icon from '@c/icon';
import Button from '@c/button';
import formFieldWrap from '@portal/modules/app-management/components/form-field-wrap';
import toast from '@lib/toast';
import { fetchDataAccessPer, saveDataAccessPer } from '@portal/modules/app-management/lib/api';
