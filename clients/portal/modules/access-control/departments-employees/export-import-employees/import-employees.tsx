...
import { SendMessage, sendMsgOption } from '../modal/reset-password-modal';
import { SEND_MAP } from '../modal/edit-employees-modal';
...
function ImportEmployees({ currDepId, onSuccess, onFail }: Props): JSX.Element {
