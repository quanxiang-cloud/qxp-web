...
export const ItemWithTitleDesc = ({
  ...
  return (
    <div
      className={
        twCascade('px-8 flex justify-start items-center md:flex-col md:items-start', className)
      }
      onClick={onClick}
    >
      {itemRender}
      <div
        className={twCascade(
          'h-full justify-between ml-dot4 flex flex-1 transition duration-300 md:ml-0 md:mt-1',
          {
