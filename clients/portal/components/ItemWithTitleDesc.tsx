...
export const ItemWithTitleDesc = ({ title , desc, itemRender, titleClassName, descClassName, textDirection }: IItemWithTitleDesc) => {

  return (
    <div className="flex justify-start items-center">
      {itemRender()}
      <div className={classnames('justify-between ml-dot-4 flex flex-1', {
