...
import { Modal, Icon, CheckboxGroup, Checkbox } from '@QCFE/lego-ui'
  ...
  return (
    ...
    >
      <div className="text-dot-7">
        ...
        <div>
          <p className="text-dot-7">向员工发送密码</p>
          <CheckboxGroup
            name="states"
            onChange={(value, name) => {
        ...
        <div>
          ...
          {/* <div className="">
            <img className="w-1-dot-2 h-1-dot-2 p-x-0-dot-4" src="./dist/images/icon_error.svg" alt="icon_error" />
            <div>点击或拖拽文件到该区域</div>
            </div> */}
